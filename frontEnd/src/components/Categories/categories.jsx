...
useEffect(() => {
  ...
  const handlerCheck = (e) => {
    ...
    setLevels({...levels, [e.target.name]: (e.target.checked) ? e.target.name : 'default'})
  }
        ...
        <div className="ei644_15299_10_3365_8_690">
          ...
          <div className="ei644_15299_10_3365_8_689">
            <div className="ei644_15299_10_3365_8_652">
              <div className="ei644_15299_10_3365_8_651">
                ...
                <label className="text-[16px] ">
                  <input type='checkbox' name='principiante' onChange={handlerCheck} className='mr-1'/>
                  Principiante
                </label>
            </div>
            <div className="ei644_15299_10_3365_8_653">
              ...
              <label className="text-[16px] ">
                <input type='checkbox' name='intermedio' onChange={handlerCheck} className='mr-1' />
                  Intermedio
              </label>
            ...
            <div className="ei644_15299_10_3365_8_684">
              ...
              <label className="text-[16px] ">
                <input type='checkbox'name='avanzado' onChange={handlerCheck} className='mr-1'/>
                  Avanzado
              </label>
            </div>
          </div>
