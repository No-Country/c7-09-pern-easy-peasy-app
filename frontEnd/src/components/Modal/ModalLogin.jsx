...
const ModalLogin = ({ children, handlerModalLogin }) => {
  ...
  newElement.className = 'modal fixed bg-[rgba(217,217,217,0.6)] flex justify-center items-center z-30 w-screen top-[var(--modal-height)] h-[calc(100vh-var(--modal-height))]';
